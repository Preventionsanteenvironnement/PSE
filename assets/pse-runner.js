// ════════════════════════════════════════════════════════════════════════
// CORRECTIF URGENT : pse-runner.js v7.3 (RGPD COMPLIANT)
...
// ============================================================================
window.tenterEnvoi = window.envoyerCopie; // Alias pour anciens devoirs

console.log(`✅ window.envoyerCopie prêt (v${RUNNER_VERSION} RGPD - resultats/{eleveCode}/copies/)`);
console.log(`✅ Compatibilité legacy: window.tenterEnvoi disponible`);
